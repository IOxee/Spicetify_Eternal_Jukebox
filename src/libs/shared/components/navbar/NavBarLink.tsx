import { getPlatformApiOrThrow } from "../../utils/spicetify-utils";
import type { History, HistoryEntry } from "../../platform/history";
import React, { useEffect, useState } from "react";
import type { LocalStorageAPI } from "../../platform/local-storage";
  ...
  if (isLibX) {
    const link = (
      ...
      >
        ...
        {props.activeIcon}
        {!isCollapsed && (
          <span className="TypeElement-balladBold-type">{props.label}</span>
        )}
      </a>
    );
